...
<div
	style="max-width: 800px; min-width: 420px; margin: 0 auto; min-height: 812px;">
					...
					<div class="card-body">
						<div class="form-group col-sm-12">
							<label for="title">제 목</label> <span class="form-control"
								id="title">${notice.title }</span>
						</div>
						<div class="row">
							<div class="form-group col-sm-4">
								<label for="writer">작성자</label> <span class="form-control"
									id="writer">${notice.writer }</span>
							</div>

							<div class="form-group col-sm-4">
								<label for="regDate">작성일</label> <span class="form-control"
									id="regDate"><fmt:formatDate value="${notice.regDate}"
										pattern="yyyy-MM-dd hh:mm" /></span>
							</div>
							<div class="form-group col-sm-4">
								<label for="viewcnt">조회수</label> <span class="form-control"
									id="viewcnt">${notice.viewcnt }</span>
							</div>
						</div>
						<div class="form-group col-sm-12">
